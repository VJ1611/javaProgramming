...
{   
    ...
    public javaConstructorChaining(String name)
    {
    	//call the constructor with (String, int) param
    	this(name, 120035);
    }
    public javaConstructorChaining(String name, int sal)
    {
    	//call the constructor with (String, int, String) param
    	this(name, sal, "Gurgaon");
    }
    public javaConstructorChaining(String name, int sal, String addr)
    {
    	this.empName=name;
    	this.empSalary=sal;
    	this.address=addr;
    ...
    {
    	javaConstructorChaining obj = new javaConstructorChaining();
        obj.disp();
    }
}
